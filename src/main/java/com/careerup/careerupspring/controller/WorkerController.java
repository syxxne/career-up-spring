...
public class WorkerController {
    ...
    @GetMapping("/workers")
    @ResponseBody
    public List<WorkerListDTO> searchWorkers(@RequestParam(value = "company", required = false) String company,
    ...
    @ResponseBody
    public WorkerDetailDTO workerDetail(@PathVariable String nickname){
